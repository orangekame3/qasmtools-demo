...
measurements[0] = measure small_qubits[0];
measurements[1] = measure small_qubits[1];
measurements[3] = measure small_qubits[0]; // measurements index 3 is out of bounds
measurements[0] = measure large_qubits[5]; // qubit index 5 is out of bounds